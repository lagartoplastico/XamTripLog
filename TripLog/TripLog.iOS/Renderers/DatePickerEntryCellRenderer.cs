...
[assembly: ExportRenderer(typeof(DatePickerEntryCell), 
    typeof(DatePickerEntryCellRenderer))]
namespace TripLog.iOS.Renderers
{
    public class DatePickerEntryCellRenderer : EntryCellRenderer
    {
            ...
            UITableViewCell reusableCell, UITableView tv)
        {
            ...
            // Create a toolbar with a done button that will close the
            // datepicker and set the selected value
            var done = new UIBarButtonItem("Done", UIBarButtonItemStyle.Done,
                (s, e) =>
                {
                    ...
                    // Update the value of the UITextFiled within the Cell
                    if (textField != null)
                    {
            ...
            if (textField != null)
            {
                ...
                if (datepickerCell != null)
                {
                    textField.Text = datepickerCell.Date
